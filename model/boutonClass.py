import pygame
class Button:
    def __init__(self, text="", left=10, top=30, width=None, height=20, picture=None, size = 10, color = [0,0,0]):
        ...
        self.top = top
        self.height = height
        self.colour1 = (color[0], color[1], color[2], 0)  # main
        self.colour2 = (255, 255, 255, 0)  # border
        self.colour3 = (30, 30, 30, 0)  # hover
        self.colour4 = (100, 100, 100, 0)
        self.fontname = "Bold Fraktur"
        ...
        if picture == None:
            self.image = pygame.image.load("data/Sprites/score_bg.png").convert() 
        else:
    ...
    def update(self):
        ...
        # up
        r, g, b, a = self.colour1
        self.buttonUP.fill(self.colour1)
        
        pygame.draw.rect(self.buttonUP, (r, g, b, a), (0, 0,self.width, self.height/2), 0)
        ...
        self.buttonUP.blit(self.font.render(self.text, False, (255, 255, 255)), ((self.width/2)-(self.text_width/2), (self.height/2)-(self.text_height/2)))
       ...
       # pygame.draw.line(self.buttonHOVER, self.colour4, (1, 2), (1, self.height-3), 1)
        ...
        self.buttonHOVER.blit(self.font.render(self.text, False, (255, 255, 255)), ((self.width/2)-(self.text_width/2), (self.height/2)-(self.text_height/2)))
        
        # down
        r, g, b, a = self.colour4
        r2, g2, b2, a2 = self.colour4
        self.buttonDOWN.fill((r, g, b))
        pygame.draw.rect(self.buttonDOWN, (r2, g2, b2, a2), (0, 0, int(self.width*0.80), int((self.height/2)*0.80)), 0)
        pygame.draw.line(self.buttonDOWN, self.colour2, (2, 0), (self.width-3, 0), int(self.bordersize*0.80))
        #pygame.draw.line(self.buttonDOWN, (r, g, b, a), (2, 1), (self.width-3, 1), 2)
        pygame.draw.line(self.buttonDOWN, self.colour2, (2, self.height-1), (self.width-3, self.height-1), int(self.bordersize*0.80))
        pygame.draw.line(self.buttonDOWN, self.colour2, (0, 2), (0, self.height-3), int(self.bordersize*0.80))
        #pygame.draw.line(self.buttonDOWN, (r, g, b, a), (1, 2), (1, self.height-3), 2)
        pygame.draw.line(self.buttonDOWN, self.colour2, (self.width-1, 2), (self.width-1, self.height-3), int(self.bordersize*0.80))
        ...
        self.buttonDOWN.blit(self.font.render(self.text, False, (255, 255, 255)), ((self.width/2)-(self.text_width/2)+1, (self.height/2)-(self.text_height/2)))
