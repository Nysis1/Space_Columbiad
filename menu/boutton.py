...
class Button:
    def __init__(self, text="", left=10, top=30, width=None, height=20, picture=None, size = 10):
        ...
        self.top = top
        self.height = height
        self.colour1 = (227, 25, 2, 0)  # main
        self.colour2 = (127, 127, 127, 0)  # border
        self.colour3 = (247, 35, 12, 0)  # hover
        self.colour4 = (207, 25, 2, 0)
        self.fontname = "Arial"
        ...
        if picture == None:
            self.image = pygame.image.load("menu/parchemin.png").convert() 
        else:
